    ...
    <Tab.Navigator
      screenOptions={({ route }) => ({
        tabBarIcon: ({ focused, color, size }) => {
          ...
          else if (route.name === 'Cours') iconName = focused ? 'book' : 'book-outline';
          else if (route.name === 'Tâches') iconName = focused ? 'checkbox' : 'checkbox-outline';
          else if (route.name === 'Étude') iconName = focused ? 'timer' : 'timer-outline';
          else if (route.name === 'Réglages') iconName = focused ? 'settings' : 'settings-outline';
